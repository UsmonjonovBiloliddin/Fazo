    ...
    <div className="Filter_inside_product_direction">
      <div className="Product_data">
        ...
        <div className="priceAndCard">
          <p>16 559 000 cум <AiOutlineExclamationCircle /></p>
          <div className="Card">
            <FiShoppingCart />
            <hr />
            {
                Heart ? <FaHeart color="red" onClick={() => setHeart(!Heart)} /> : <FaRegHeart onClick={() => setHeart(!Heart)}/>
            }
        ...
        <div className="text">
          <p> <RiWechatLine /> VIP скидки для VIP клиентов</p>
        </div>
